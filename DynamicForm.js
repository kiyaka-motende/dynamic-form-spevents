...
var DynamicForm = /** @class */ (function (_super) {
    ...
    function DynamicForm(props) {
        ...
        _this.getFieldInformations = function () { return __awaiter(_this, void 0, void 0, function () {
            var _a, context, listId, listItemId, disabledFields, contentTypeId, spList, item, defaultContentType, listFeilds, tempFields, order, responseValue, _loop_3, this_2, i, len, error_4;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.props, context = _a.context, listId = _a.listId, listItemId = _a.listItemId, disabledFields = _a.disabledFields;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (contentTypeId !== undefined && contentTypeId !== '') {
                            apiUrl = webAbsoluteUrl + "/_api/web/lists(@listId)/contenttypes('" + contentTypeId + "')/fields?@listId=guid'" + encodeURIComponent(listId) + "'&$filter=ReadOnlyField eq false and Hidden eq false and (FromBaseType eq true or StaticName eq 'Title')";
                        }
                        else {
                            apiUrl = webAbsoluteUrl + "/_api/web/lists(@listId)/fields?@listId=guid'" + encodeURIComponent(listId) + "'&$filter=ReadOnlyField eq false and Hidden eq false and (FromBaseType eq true or StaticName eq 'Title')";
                        }
