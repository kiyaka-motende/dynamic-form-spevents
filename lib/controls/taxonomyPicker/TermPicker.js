...
var TermPicker = /** @class */ (function (_super) {
    ...
    TermPicker.prototype.render = function () {
        ...
        var clearDisplayValue = function () {
            ...
            var autoFill = (_a = picker === null || picker === void 0 ? void 0 : picker['input']) === null || _a === void 0 ? void 0 : _a.current;
            if (autoFill) {
                autoFill['_value'] = '';
        ...
        if (onNewTerm) {
            inputProps.onKeyDown = function (e) {
                var _a;
                if (e && e.key === 'Enter' && (!(e.ctrlKey || e.altKey || e.shiftKey)) && ((_a = e.target) === null || _a === void 0 ? void 0 : _a['value'])) {
