...
export var useSpAPI = function () {
    ...
    var deleteComment = useCallback(function (commentId) { return __awaiter(void 0, void 0, void 0, function () {
        var spHttpClient, _endPointUrl, spOpts, _deleteResults;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!spHttpClient)
                        return [2 /*return*/];
                    _endPointUrl = (webUrl !== null && webUrl !== void 0 ? webUrl : _webUrl) + "/_api/web/lists(@a1)/GetItemById(@a2)/Comments(@a3)?@a1='" + listId + "'&@a2='" + itemId + "'&@a3='" + commentId + "'";
                    spOpts = {
                        method: "DELETE",
                    };
                    return [4 /*yield*/, spHttpClient.fetch("" + _endPointUrl, SPHttpClient.configurations.v1, spOpts)];
                case 1:
                    _deleteResults = _a.sent();
                    return [2 /*return*/];
            }
        });
    }); }, [serviceScope]);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!spHttpClient)
                        return [2 /*return*/];
                    _endPointUrl = (webUrl !== null && webUrl !== void 0 ? webUrl : _webUrl) + "/_api/web/lists(@a1)/GetItemById(@a2)/Comments()?@a1='" + listId + "'&@a2='" + itemId + "'";
                    spOpts = {
                        body: "{ \"text\": \"" + comment.text + "\", \"mentions\": " + JSON.stringify(comment.mentions) + "}",
                    };
                    return [4 /*yield*/, spHttpClient.post("" + _endPointUrl, SPHttpClient.configurations.v1, spOpts)];
                case 1:
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if (!spHttpClient)
                        return [2 /*return*/];
                    _endPointUrl = (webUrl !== null && webUrl !== void 0 ? webUrl : _webUrl) + "/_api/web/lists(@a1)/GetItemById(@a2)/GetComments()?@a1='" + listId + "'&@a2='" + itemId + "'&$top=" + (numberCommentsPerPage !== null && numberCommentsPerPage !== void 0 ? numberCommentsPerPage : 10);
                    return [4 /*yield*/, spHttpClient.get("" + _endPointUrl, SPHttpClient.configurations.v1)];
                case 1:
