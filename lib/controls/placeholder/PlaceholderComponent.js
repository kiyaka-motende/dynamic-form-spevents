...
var Placeholder = /** @class */ (function (_super) {
    ...
    Placeholder.prototype.render = function () {
        ...
        return (React.createElement(ThemeContext.Consumer, null, function (contextTheme) {
            ...
            var iconTextClassNames = styles.placeholderText + " " + ((_this.state.width && _this.state.width <= 380) ? styles.hide : "");
            ...
            return (React.createElement("div", { className: styles.placeholder + " " + (_this.props.contentClassName ? _this.props.contentClassName : ''), ref: _this._linkElm },
