        ...
        _this._renderGridList = function () {
            return React.createElement("span", { className: styles.recentGridList, role: "grid" },
                React.createElement(FocusZone, null,
                    React.createElement(SelectionZone, { selection: _this._selection, selectionMode: SelectionMode.multiple, onItemInvoked: function (item) { return _this._handleItemInvoked(item); } },
