...
var FileBrowser = /** @class */ (function (_super) {
                ...
                React.createElement("div", null,
                    ...
                    React.createElement("div", { className: styles.scrollablePaneWrapper },
                        React.createElement(ScrollablePane, null, this.state.selectedView !== 'tiles' ?
                            ...
                            (React.createElement(TilesList, { fileBrowserService: this.props.fileBrowserService, filePickerResult: this.state.filePickerResults ? this.state.filePickerResults[0] : null, selection: this._selection, items: this.state.items, onFolderOpen: this._handleOpenFolder, onFileSelected: this._itemSelectionChanged, onNextPageDataRequest: this._loadNextDataRequest }))))),
    ...
    FileBrowser.prototype._getListItems = function (concatenateResults) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var _a, libraryUrl, folderPath, accepts, fileBrowserService, _b, items, nextPageQueryString, filesQueryResult, loadingState, sortField, isDesc, sortByCol, error_1, newItems;
    ...
    FileBrowser.prototype._onClientSort = function (column) {
    };
    return FileBrowser;
}(React.Component));
export { FileBrowser };
