...
var TreeItemActionsControl = /** @class */ (function (_super) {
    ...
    TreeItemActionsControl.prototype.render = function () {
        ...
        return (React.createElement("div", null, displayMode == TreeItemActionsDisplayMode.ContextualMenu ?
            React.createElement(DropdownTreeItemAction, { key: "DdAction-" + treeItem.key, treeItemActions: availableActions, treeItem: treeItem, treeItemActionCallback: this.props.treeItemActionCallback, theme: this.props.theme })
            :
                React.createElement(ButtonTreeItemAction, { key: "BtnAction-" + treeItem.key, treeItemActions: availableActions, treeItem: treeItem, treeItemActionCallback: this.props.treeItemActionCallback, theme: this.props.theme })));
    };
