...
import { Label, Selection, } from 'office-ui-fabric-react';
...
export function TaxonomyPanelContents(props) {
    ...
    var _m = React.useState(((_a = props.selectedPanelOptions) === null || _a === void 0 ? void 0 : _a.length) > 0 ? __spreadArrays(props.selectedPanelOptions) : []), terms = _m[0], setTerms = _m[1];
