...
var LocationPicker = /** @class */ (function (_super) {
    ...
    */
    ...
    LocationPicker.prototype.componentWillReceiveProps = function (nextProps) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.props.context.spHttpClient.post(this.props.context.pageContext.web.absoluteUrl + "/_api/SP.OAuth.Token/Acquire", SPHttpClient.configurations.v1, spOpts)];
                    case 1:
                        response = _a.sent();
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        json.MeetingLocations.forEach(function (v, i) {
                            var loc = v["MeetingLocation"];
                            optionsForCustomRender_1.push({ text: v.MeetingLocation["DisplayName"], key: i, locationItem: loc });
                        });
