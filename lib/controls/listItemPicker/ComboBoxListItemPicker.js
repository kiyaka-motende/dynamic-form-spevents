...
var ComboBoxListItemPicker = /** @class */ (function (_super) {
    ...
    function ComboBoxListItemPicker(props) {
        ...
        _this.onChanged = function (option, index, value, submitPendingValueEvent) {
            var _a, _b;
            var selectedItems = cloneDeep(_this.state.selectedItems);
    ...
    ComboBoxListItemPicker.prototype.loadOptions = function (props, isInitialLoad) {
        return __awaiter(this, void 0, void 0, function () {
            var filter, keyColumnInternalName, listId, columnInternalName, webUrl, itemLimit, onInitialized, orderBy, query, keyColumnName, listItems, selectedItems;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        filter = props.filter, keyColumnInternalName = props.keyColumnInternalName, listId = props.listId, columnInternalName = props.columnInternalName, webUrl = props.webUrl, itemLimit = props.itemLimit, onInitialized = props.onInitialized, orderBy = props.orderBy;
                        query = filter || "";
                        ...
                        return [4 /*yield*/, this._listItemRepo.getListItemsByFilterClause(query, listId, columnInternalName, keyColumnInternalName, webUrl, itemLimit || 100, orderBy)];
                    case 1:
                        listItems = _a.sent();
