...
var DateTimePicker = /** @class */ (function (_super) {
    ...
    DateTimePicker.prototype.render = function () {
        ...
        var _a = this.props, label = _a.label, disabled = _a.disabled, timeConvention = _a.timeConvention, _b = _a.dateConvention, dateConvention = _b === void 0 ? DateConvention.DateTime : _b, firstDayOfWeek = _a.firstDayOfWeek, _c = _a.isMonthPickerVisible, isMonthPickerVisible = _c === void 0 ? true : _c, showGoToToday = _a.showGoToToday, _d = _a.allowTextInput, allowTextInput = _d === void 0 ? true : _d, _e = _a.showMonthPickerAsOverlay, showMonthPickerAsOverlay = _e === void 0 ? false : _e, _f = _a.showWeekNumbers, showWeekNumbers = _f === void 0 ? false : _f, _g = _a.showSeconds, showSeconds = _g === void 0 ? false : _g, formatDate = _a.formatDate, _h = _a.value, value = _h === void 0 ? this.state.day : _h, _j = _a.strings, dateStrings = _j === void 0 ? new DateTimePickerStrings() : _j, // Defines the DatePicker control labels
        timeDisplayControlType = _a.timeDisplayControlType, placeholder = _a.placeholder, showLabels = _a.showLabels, minDate = _a.minDate, maxDate = _a.maxDate, minutesIncrementStep = _a.minutesIncrementStep, _k = _a.showClearDate, showClearDate = _k === void 0 ? false : _k, _l = _a.showClearDateIcon, showClearDateIcon = _l === void 0 ? 'RemoveEvent' : _l;
        ...
        return (React.createElement("div", { className: styles.dateTimePicker },
            ...
            React.createElement("div", { className: styles.container },
                React.createElement("div", { className: styles.row },
                    ...
                    React.createElement("div", { className: styles.picker },
                        React.createElement(DatePicker, { formatDate: formatDate, disabled: disabled, value: value, strings: dateStrings, isMonthPickerVisible: isMonthPickerVisible, onSelectDate: this.onSelectDate, allowTextInput: allowTextInput, firstDayOfWeek: firstDayOfWeek, showGoToToday: showGoToToday, showMonthPickerAsOverlay: showMonthPickerAsOverlay, showWeekNumbers: showWeekNumbers, placeholder: placeholder, minDate: minDate, maxDate: maxDate, textField: {
                                onChange: function (e, newValue) { return _this.handleTextChange(e, newValue, textErrorMessage); }
                            } })),
                    showClearDate === true && this.state.day !== null ? React.createElement(IconButton, { iconProps: { iconName: showClearDateIcon }, onClick: function () { return _this.clearDate(); } }) : React.createElement(React.Fragment, null)),
                timeElm),
