...
export var TeamChannelPicker = function (props) {
    ...
    var onSelectedChannels = props.onSelectedChannels, selectedChannels = props.selectedChannels, itemLimit = props.itemLimit, label = props.label, styles = props.styles, themeVariant = props.themeVariant;
                ...
                case 2:
                    ...
                    if (teamsChannels === null || teamsChannels === void 0 ? void 0 : teamsChannels.length) {
                        for (_i = 0, teamsChannels_1 = teamsChannels; _i < teamsChannels_1.length; _i++) {
                            ...
                            tags.push({
                                key: teamChannel.id,
                                name: teamChannel.displayName + "," + teamChannel.membershipType + "," + ((_a = teamChannel.isFavoriteByDefault) !== null && _a !== void 0 ? _a : "false"),
                            });
                        }
                    }
                    return [3 /*break*/, 4];
