...
var SPService = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        queryUrlString = options.listId ? this._webAbsoluteUrl + "/_api/web/lists('" + options.listId + "')/ContentTypes?" : this._webAbsoluteUrl + "/_api/web/ContentTypes?";
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        queryUrlString = this._webAbsoluteUrl + "/_api/web";
                        if (options.listId) {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (field && field.TypeAsString === 'Calculated' && SPHelper.isTextFieldType(field.ResultType)) { // for calculated fields we need to use CAML query
                            ...
                            mapKey_1 = webAbsoluteUrl + "##" + listId + "##" + internalColumnName + "##" + (keyInternalColumnName || 'Id');
  ...
  */
    ...
    SPService.prototype.deleteAttachment = function (fileName, listId, itemId, webUrl) {
        return __awaiter(this, void 0, void 0, function () {
            var spOpts, webAbsoluteUrl, apiUrl, data, error_7;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
    ...
    SPService.prototype.addAttachment = function (listId, itemId, fileName, file, webUrl) {
        return __awaiter(this, void 0, void 0, function () {
            var fileExists, spOpts, webAbsoluteUrl, apiUrl, data, error_8;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        apiUrl = webAbsoluteUrl + "/_api/web/lists(@listId)/items(" + listItemID + ")/?@listId=guid'" + encodeURIComponent(listId) + "'&$select=" + fieldName + "/ID," + fieldName + "/" + (lookupFieldName || 'Title') + "&$expand=" + fieldName;
                        return [4 /*yield*/, this._context.spHttpClient.get(apiUrl, SPHttpClient.configurations.v1)];
                    case 1:
                        data = _a.sent();
                        if (!data.ok) return [3 /*break*/, 3];
    ...
    SPService.prototype.getLookupValues = function (listId, listItemID, fieldName, lookupFieldName, webUrl) {
        return __awaiter(this, void 0, void 0, function () {
            var webAbsoluteUrl, apiUrl, data, result, lookups_1, error_11;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
    ...
    SPService.prototype.getUserUPNById = function (userId, webUrl) {
        return __awaiter(this, void 0, void 0, function () {
            var webAbsoluteUrl, apiUrl, data, results, error_14;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
