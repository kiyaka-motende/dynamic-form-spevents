...
var SPPeopleSearchService = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [2 /*return*/, 1];
                    case 1: return [4 /*yield*/, this.searchTenant(siteUrl, groupName, 1, [PrincipalType.SharePointGroup], false, false, 0)];
                    case 2:
                        groups = _a.sent();
    ...
    SPPeopleSearchService.prototype.searchPersonByEmailOrLogin = function (email, principalTypes, siteUrl, groupId, ensureUser, allowUnvalidated) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var mockUsers, userResults, _i, groupId_1, id, tmpResults, logins_1, filteredUserResults, userResults;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        if (!Array.isArray(groupId)) return [3 /*break*/, 7];
                        userResults = [];
                        _i = 0, groupId_1 = groupId;
                        _a.label = 3;
                    case 3:
                        if (!(_i < groupId_1.length)) return [3 /*break*/, 6];
                        id = groupId_1[_i];
                    ...
                    case 7: return [4 /*yield*/, this.searchTenant(siteUrl, email, 1, principalTypes, ensureUser, allowUnvalidated, groupId)];
                    case 8:
                        userResults = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        if (!Array.isArray(groupId)) return [3 /*break*/, 6];
                        userResults = [];
                        _i = 0, groupId_2 = groupId;
                        _a.label = 2;
                    case 2:
                        if (!(_i < groupId_2.length)) return [3 /*break*/, 5];
                        id = groupId_2[_i];
                    ...
                    case 6: return [4 /*yield*/, this.searchTenant(siteUrl, query, maximumSuggestions, principalTypes, ensureUser, allowUnvalidated, groupId)];
    ...
    SPPeopleSearchService.prototype.searchTenant = function (siteUrl, query, maximumSuggestions, principalTypes, ensureUser, allowUnvalidated, groupId) {
        return __awaiter(this, void 0, void 0, function () {
            var userRequestUrl, searchBody, graphUserRequestUrl, graphClient, graphUserResponse, _users_2, batch, _i, _a, value, userResult, _b, _users_1, user, httpPostOptions, data, userDataResp, values, _c, values_1, value, id, userResults, e_2;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        graphUserRequestUrl = "/groups/" + groupId + "/transitiveMembers?$count=true&$search=\"displayName:" + query + "\" OR \"mail:" + query + "\"";
                    ...
                    case 3:
                        ...
                        for (_i = 0, _a = graphUserResponse.value; _i < _a.length; _i++) {
                            value = _a[_i];
                            sp.web.inBatch(batch).ensureUser(value.userPrincipalName).then(function (u) { return _users_2.push(u.data); });
                        }
