            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        apiUrl = "https://api.bing.microsoft.com/v7.0/images/search?q=" + encodeURIComponent(query) + "&count=" + maxResults + "&aspect=" + aspect + "&maxFileSize=" + maxFileSize + "&size=" + size + "&mkt=en-US&license=" + license;
