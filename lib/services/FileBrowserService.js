    ...
    function FileBrowserService(context, itemsToDownloadCount, siteAbsoluteUrl) {
        ...
        this.getListItems = function (listUrl, folderPath, acceptedFilesExtensions, nextPageQueryStringParams, sortBy, isDesc) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        restApi = this.siteAbsoluteUrl + "/_api/web/GetList('" + listUrl + "')/RenderListDataAsStream";
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        restApi = absoluteUrl + "/_api/web/GetFolderByServerRelativeUrl('" + internalName + "')/Properties?$select=vti_x005f_listtitle";
                        return [4 /*yield*/, this.context.spHttpClient.get(restApi, SPHttpClient.configurations.v1)];
                    case 1:
                    ...
                    case 3:
                        error_3 = _a.sent();
                        console.error("[FileBrowserService.getSiteLibraryNameByInternalName]: Err='" + error_3.message + "'");
                        return [2 /*return*/, null];
                    case 4: return [2 /*return*/];
                }
            });
        ...
        this.getSiteTitle = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        restApi = this.siteAbsoluteUrl + "/_api/web?$select=Title";
                        return [4 /*yield*/, this.context.spHttpClient.get(restApi, SPHttpClient.configurations.v1)];
                    case 1:
                        webResult = _a.sent();
        ...
        this.getSiteTitleAndId = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        restApi = this.siteAbsoluteUrl + "/_api/web?$select=Title,Id";
                        return [4 /*yield*/, this.context.spHttpClient.get(restApi, SPHttpClient.configurations.v1)];
                    case 1:
                        webResult = _a.sent();
                        if (!webResult || !webResult.ok) {
