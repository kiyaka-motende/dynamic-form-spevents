                ...
                case 'DateTime':
                    return React.createElement("div", { className: styles.fieldContainer },
                        React.createElement("div", { className: styles.titleContainer },
                            ...
                            labelEl),
                        dateFormat === 'DateOnly' &&
                            React.createElement(DatePicker, { placeholder: placeholder, className: styles.pickersContainer, formatDate: function (date) { return date.toLocaleDateString(context.pageContext.cultureInfo.currentCultureName); }, value: (changedValue !== null && changedValue !== "") ? changedValue : defaultValue, onSelectDate: function (newDate) { _this.onChange(newDate); }, disabled: disabled }),
                        dateFormat === 'DateTime' &&
                            React.createElement(DateTimePicker, { key: columnInternalName, placeholder: placeholder, formatDate: function (date) { return date.toLocaleDateString(context.pageContext.cultureInfo.currentCultureName); }, value: (changedValue !== null && changedValue !== "") ? changedValue : defaultValue, onChange: function (newDate) { _this.onChange(newDate); }, disabled: disabled }),
                        descriptionEl,
                        errorTextEl);
                case 'Boolean':
                    return React.createElement("div", null,
